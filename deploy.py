...
class OpenVLAServer:
    def __init__(self, openvla_path: Union[str, Path], attn_implementation: Optional[str] = "flash_attention_2") -> Path:
        ...
        # print("device ", self.device) #cuda: 0 in default
    ...
    # def run(self, host: str = "10.138.130.85", port: int = 8000) -> None:
    # def run(self, host: str = "172.20.10.2", port: int = 8000) -> None:
        self.app = FastAPI()
...
class DeployConfig:
    ...
    host: str = "0.0.0.0"
    # host: str = "172.20.10.2"                                               # Host IP Address
